...
const imagesFilename = {
    "brand_logo": extractSrc(importAll(require.context('../../public/assets/images/brand_logo', false, /\.(png|jpe?g|webp)$/))),
    "anime": extractSrc(importAll(require.context('../../public/assets/images/anime', false, /\.(png|jpe?g|webp)$/))),
    "video_game": extractSrc(importAll(require.context('../../public/assets/images/video_game', false, /\.(png|jpe?g|webp)$/)))
}
